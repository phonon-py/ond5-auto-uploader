...
if __name__ == "__main__":
    input_csv = "/Users/kimuratoshiyuki/Downloads/pond5 (2).csv"
    output_csv = "/Users/kimuratoshiyuki/Downloads/pond5_cleaned_v3.csv"

    print("=" * 60)
    print("Pond5 CSV クリーニングツール v3")
    print("=" * 60)
